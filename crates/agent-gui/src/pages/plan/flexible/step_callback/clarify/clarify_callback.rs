...
//! 不涉及「用户是否认同该需求」——用户不认同就会继续补充 / 修改，协调器重跑需求澄清后
//! 回调再登记一次、覆盖旧值，二者不冲突。
//!
...
pub(super) const AGENT: &str = "flexible_clarify";
...
#[async_trait]
impl SubAgentResultCallback for ClarifyCallback {
