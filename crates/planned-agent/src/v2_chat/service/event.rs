//! v2 聊天事件协议
//!
//! [`V2ChatEvent`] 在复用 core 层 [`ChatEvent`]（流式增量 / 工具执行 /
...
use crate::v2_chat::state::SubscribersInner;
...
/// 事件订阅 ID，由 [`crate::v2_chat::V2ChatService::on_chat`] 返回，
/// 用于 [`crate::v2_chat::V2ChatService::unsubscribe`] 退订。
///
...
///
/// 由 [`crate::v2_chat::V2ChatService::on_chat_with_guard`] 返回。
...
impl SubscriptionGuard {
    /// 由 [`crate::v2_chat::V2ChatService::on_chat_with_guard`] 内部调用，
